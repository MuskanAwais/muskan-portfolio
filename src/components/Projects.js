...
import todo from "../assets/To do.jfif";
import miniOS from "../assets/miniOS.jfif";
import event from "../assets/ticket.png";
import iot from "../assets/weather.jfif";
import blood from "../assets/blood.jfif";
...
const projects = [
  {
    id: 7,
    name: "Quiz Generator",
    href: "https://quiz-generator-amber.vercel.app",
    imageSrc: quiz, // 🔄 Make sure the image is placed correctly in your /src/assets folder
    used: "React.js, GROQ API, Vite, CSS",
    description:
      "An AI-powered quiz application where users can dynamically generate quizzes based on input topics. Built using React and GROQ API to fetch contextual questions, it features clean UI, and seamless user experience.",
  },
  ...
  },
  {
    ...
    imageSrc: event, // Replace with your own image
    used: "MERN Stack",
    description:
  ...
  },
  {
    ...
    href: "#",
    imageSrc: todo, // Replace with your own image
    used: "MERN Stack",
    description:
  ...
  },
  {
    ...
    imageSrc: miniOS, // Replace with your own image
  ...
  },
  {
    ...
    imageSrc: blood, // Replace with your own image
  ...
  },
  {
    ...
    imageSrc: iot, // Replace with your own image
